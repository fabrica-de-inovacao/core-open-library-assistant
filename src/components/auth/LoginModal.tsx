      ...
      <DialogContent className="sm:max-w-sm">
        ...
        <div className="mt-2 flex flex-col gap-4">
          ...
          <p className="text-muted-foreground mt-2 text-center text-xs">
            No modo anônimo seus dados de sessão não são retidos de forma persistente nem utilizados
            para quaisquer fins que não sejam permitir o teste das funcionalidades.
          </p>
        </div>
      </DialogContent>
    </Dialog>
